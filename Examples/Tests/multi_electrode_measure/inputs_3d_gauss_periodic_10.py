#!/usr/bin/env python3
"""3D Gauss-box test: periodic Gauss clean + harmonic bias every 10 steps.
...
followed by harmonic bias) is applied every 10 timesteps throughout the
entire simulation.

Usage:
    python inputs_3d_gauss_periodic_10.py
"""
